		...
		<div class="container home-blog">
			<div class="row">
				...
				<div class="center-title">
						<?php if($wl_theme_options['subtitulo-home-blog']!='') { ?>
						<div class="heading-title">
							<h3 class="subtitulo-green"><?php echo esc_html($wl_theme_options['subtitulo-home-blog']); ?></h3>
						</div>
						<?php } ?>
						<?php if($wl_theme_options['titulo-home-blog']!='') { ?>
						<h1 class="titulo-black"> <?php echo html_entity_decode(get_theme_mod('titulo-home-blog' , $wl_theme_options['titulo-home-blog'])); ?></h1>
						<?php } ?>
					</div>
				</div>
			</div>
