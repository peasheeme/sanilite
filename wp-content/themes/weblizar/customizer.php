...
function weblizar_customizer( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial( 'weblizar_options[slide_desc_3]', array(
	'selector' => '.weblizar_slide_desc_3',
	'render_callback' => 'weblizar_options[slide_desc_3]',
	) );
	$wp_customize->add_setting(
	...
	$wp_customize->add_control( 'weblizar_slide_desc_4', array(
		'label'        => __( 'Slider Description One', 'weblizar' ),
		'type'=>'text',
		'section'    => 'slider_sec',
		'settings'   => 'weblizar_options[slide_desc_3]'
	) );
