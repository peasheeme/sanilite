(function ( $, window, document, undefined ) {
    ...
    $('body').on('click','.media-image-remove', function(e){
    ...
    function at_date_picker( widgetContainer ) {
        widgetContainer.find(".at-date-picker").each(function(){
            $(this).datetimepicker({
                separator: ' - ',
                dateFormat: 'dd/mm/yy'
            });
    ...
    at_document.ready( function() {
        at_document.on('widget-added widget-updated widget-synced', function( event, widgetContainer ) {
            ATSORTABLE();
            at_date_picker(widgetContainer)
        });
        ...
        function at_build_hide_unnecessary_meta() {
            var page_template = $('#page_template'),
                event_star_sidebar_layout = $('#event_star_sidebar_layout'),
                event_star_meta_fields = $('#event_star_meta_fields'),
            ...
            if( valueSelected === 'page-templates/template-builder.php' ){
                event_star_sidebar_layout.addClass('hidden');
                event_star_meta_fields.addClass('hidden');
                postimagediv.addClass('hidden');
            }
            else{
                event_star_sidebar_layout.removeClass('hidden');
                event_star_meta_fields.removeClass('hidden');
