 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Event_Star_Testimonial' ) ) {

    class Event_Star_Testimonial extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id('bg_image'); ?>">
                    <?php esc_html_e( 'Select Background Image', 'event-star' ); ?>
                </label>
                <?php
                $event_star_display_none = '';
                if ( empty( $bg_image ) ){
                    $event_star_display_none = ' style="display:none;" ';
                }
                ?>
                <span class="img-preview-wrap" <?php echo  $event_star_display_none ; ?>>
                    <img class="widefat" src="<?php echo esc_url( $bg_image ); ?>" alt="<?php esc_attr_e( 'Image preview', 'event-star' ); ?>"  />
                ...
                <input type="button" value="<?php esc_attr_e( 'Upload Image', 'event-star' ); ?>" class="button media-image-upload" data-title="<?php esc_attr_e( 'Select Background Image','event-star'); ?>" data-button="<?php esc_attr_e( 'Select Background Image','event-star'); ?>"/>
                <input type="button" value="<?php esc_attr_e( 'Remove Image', 'event-star' ); ?>" class="button media-image-remove" />
            </p>
            <p>
        ...
        public function widget($args, $instance) {
            ...
            ?>
            <section id="<?php echo $unique_id;?>" class="at-widgets acme-testimonials <?php echo $bg_image_class; ?>" style="<?php echo $bg_image_style; ?>">
                <div class="container">
	                <?php
	                if( !empty( $title ) ) {
                    ...
                    <div class="row acme-widget-carausel">
                        ...
                        if( !empty ( $post_in ) ) :
	                        ...
	                        $testimonial_query = new WP_Query( $event_star_post_in_page_args );
                            /*The Loop*/
    ...
    } // Class Event_Star_Testimonial ends here
}